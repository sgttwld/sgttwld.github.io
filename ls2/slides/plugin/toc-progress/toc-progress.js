	...
	for (var main_sections_index=0;main_sections_index<main_sections.length;main_sections_index++)
	{
		...
		var main_title_set = false;
		{
			...
			if (title_element!=null && (!title_element.hasAttribute('class') || title_element.getAttribute('class').indexOf('no-toc-progress')==-1))
			{
				...
				style_node.textContent=style_node.textContent+'.toc-progress-'+main_sections_index.toString()+' #toc-progress-'+main_sections_index.toString()+' {font-weight: bold; color: #000;}\n';
				style_node.textContent=style_node.textContent+this.viewport+'[class*="toc-progress-'+main_sections_index.toString()+'-"] #toc-progress-'+main_sections_index.toString()+' {font-weight: bold; color: #000;}\n';
...
toc_progress.initialize=function(reducescroll,background,viewport)
{
	...
	this.background=background || 'rgba(255,255,255,0.1)';
